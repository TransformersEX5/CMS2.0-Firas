...
/**
 * This is the model class for table "tblmenpower".
 *
 ...
 * @property int $UserId
 */
class Tblmenpower extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['PositionId', 'CampusId', 'DepartmentId', 'UserId'], 'required'],
            [['PositionId', 'CampusId', 'DepartmentId', 'TotRequired', 'TypeRequestId', 'DueToRequest', 'EmploymentStatusId', 'DurationEmployment', 'TotTeachHours', 'CheckListCompletForm', 'CheckListOrgChart', 'CheckListJD', 'UserId'], 'integer'],
