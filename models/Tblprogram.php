...
class Tblprogram extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ProgramCode', 'ProgramName', 'ProgramCode2', 'ProgramCode3', 'ProgramName3', 'FacultyId', 'SchoolId', 'ProgramType', 'ProgramFromId', 'ProgramStatus', 'ActCreditHours', 'StudyDurationFT', 'StudyDurationPT', 'AcadCalTypeId', 'TransactionUpdated', 'ProgramDesc', 'ProgSubFieldId', 'LearningMethodId', 'NecDetailId', 'PracticalStatusId'], 'required'],
