...
$this->title = Yii::t('app', 'training Provider');
...
<?php
/**********************************************************************************/
$url = Url::toRoute(['/trainingprovider/trainingproviderlist']);
$create = Url::toRoute(['/trainingprovider/create']);
$update = Url::toRoute(['/trainingprovider/update']);
$view = Url::toRoute(['/trainingprovider/view']);
...
$('#btn_search').click(function () {
      ...
      $('#cmstable1').dataTable().empty();
		...
		var table = $('#cmstable1').DataTable({
			...
			"columns": [
				{"data":"TrainingProviderId", "visible": false},
				{"data":"TrainingCompanyName","width": '30%'},	
                {"data":"TrainingContactName","width": '30%'},	                
				{"data":"TrainingProviderStatus","width": '10%'},	
	...
	$('#cmstable1 tbody').on('click', 'tr', function() {
     // console.log(table.row(this).data());
			...
			var x = d['TrainingCompanyName'];
			var y = d['TrainingProviderId'];
      ...
      $.ajax({
            ...
            {    // console.log(response);
             ...
             // console.log(response.message);
				...
				document.getElementById('modalHeader-lg').innerHTML = '<h4>New Training Provider</h4>';    
  ...
  /**********************************************************************************/
	$(document).on('click', '.showModal_View', function () {
      ...
      $.ajax({
            ...
            type   : 'GET',
			data: {
                TrainingProviderId: $("#select_id").val(),
                 },
             success: function (response) 
            {     
				$('#modal-lg').modal('show');
                $('#modalContent-lg').html(response).modal();							
				document.getElementById('modalHeader-lg').innerHTML = '<h4>View Training Provider</h4>';
	...
	$(document).on('click', '.showModal_Update', function () {
      ...
      $.ajax({
            ...
            {                     
                $('#modal-lg').modal('show');
                $('#modalContent-lg').html(response).modal();							
				document.getElementById('modalHeader-lg').innerHTML = '<h4>Edit Training Provider</h4>';
            },
            error  : function (e) {
				   // console.log(e);
            }
