    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="form-group mt-3 d-flex justify-content-end">
                ...
                echo '&nbsp';
                if ($pageUrl != 'view') {
                    echo Html::submitButton(Yii::t('app', 'Confirm'), ['class' => 'btn btn-success generateTrainingsummary']);
                }
...
$( document ).ready(function() {
    $(document).on('click', '.generateTrainingsummary', function() {
        var year = document.getElementById('textBoxId').value;

        if(year == '')
        {
            alert('Please enter the training year!');
        }
        else
        {
            window.open('rpt_trainingsummary?year='+year);
        }
    });
});
