...
$urlTypedetails = Url::base() . '/datinproperty/typedetails';
$_csrf = Yii::$app->request->getCsrfToken();

// Swal.fire("Success!",desc2,"success")
$script = <<< JS
    ...
    <div class="card-body mt-0">
        <div class="row">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><?php if (!isset($model->TypeId)) { ?>Register<?php } else { ?>Update<?php } ?></button>
            </div>
        </div>
