...
$result = \Yii::$app->db->createCommand("CALL GetMarketingExgratiaPaymentReport_P2($param1)");
$result->execute();

/****SetHTMLHeader********************************************************************************************************************************************* */
$mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">Summary Exgratia P2 Claim for ' . $param1 . '</div>');
echo '<br>';
/************************************************************************************************************************************************* */
...
<body>
    ...
    <table width="100%" border="0">
        <tbody>
            <tr>
                <td align="left">Note Exgratia P2 Claim :</td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left">4- MUST Paid full Sem One fee </td>
            </tr>
    ...
    <br>
    <strong>
        <h3>Summary Exgratia P2 Claim</h3>
    </strong>
        ...
        <table width="100%" class="spacebar table" border="1">
            ...
            <?php foreach ($result as $result) { ?>
                ...
                <tr>
                    ...
                    <td align="center"><?= $result['TotClaimP2']; ?> </td>
                </tr>
    ...
    <pagebreak>
        ...
        $Staff  = "SELECT
                    ...
                    where date_format(tblexgratia.P2,'%Y%m') = $param1 
        ...
        foreach ($Staffdata as $Staffdata) {
            ...
            $select = " SELECT
                    ...
                    where tblmarketingapplicationfee_temp.UserNo = $UserNo and  
                        date_format(tblexgratia.P2,'%Y%m') = $param1 
        ...
        <pagebreak>
            ...
            $sbslist = " SELECT
                        ...
                        INNER JOIN tblexgratia ON tblexgratia.ProgramRegId = tblmarketingapplicationfee_temp.ProgramRegId 
                        AND tblexgratia.Branch = tblmarketingapplicationfee_temp.QFrom
                        where tblmarketingapplicationfee_temp.SBS ='Yes'  
                        and date_format(tblexgratia.P2,'%Y%m') = $param1     
                ...
                <table width="100%" class="spacebar table" border="1">
                    ...
                    <?php foreach ($studsbs as $studsbs) { ?>
                        ...
                        <tr>
                            ...
                            <td align="center" width='7%'><?= $studsbs['SemOne_FullPaid']; ?> </td>
            ...
            <pagebreak>
                ...
                $agentlist = " SELECT
                                ...
                                FROM tblmarketingapplicationfee_temp
                                INNER JOIN tblexgratia ON tblexgratia.ProgramRegId = tblmarketingapplicationfee_temp.ProgramRegId AND tblexgratia.Branch = tblmarketingapplicationfee_temp.QFrom
                                where tblmarketingapplicationfee_temp.Agents ='Yes'  
                                and date_format(tblexgratia.P2,'%Y%m') = $param1     
