...
WHERE TrainingDurationId = $AttendanceId
...
function  getPaticipant($TrainingId,$AttendanceId)
{
    ...
    tbldepartment.DepartmentDesc,
		CASE WHEN tbltrainingattandance.AttandId = 1 THEN 'Attend' ELSE 'Not Attend' END AS Attendance
    FROM
    ...
    where  tbltrainingattandance.TrainingId = $TrainingId AND TrainingDurationId = $AttendanceId
...
$mpdf->SetHTMLHeader('<div style="text-align: left; font-family: tahoma; font-weight: bold; color:#000; font-size: 20pt;  ">List of Training '.$result[0]['TrainingDate'].'</div>');
...
<body>
    ...
    $data = getPaticipant($TrainingId,$AttendanceId);
