...
$resetPassword = Url::toRoute(['/site/sendemail']);
    ...
    $(document).on('click', '.sendEmail', function() {
        ...
        if(email != '')
        {
            $.ajax({
                ...
                {
                    $('#errorMessage').text('A new password has been sent to '+email+'. Please check the email.');
                    $('#emailPanel').hide();
                },
                error: function(xhr, status, error) 
                {
                    $('#errorMessage').text('The email does not exist! Please make sure the email that you have entered is correct!');
                }
            });
        }
        else
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div id="errorMessage" class="alert alert-borderless alert-warning text-center mb-2 mx-2" role="alert">
                                    Enter your email and instructions will be sent to you!
                                </div>
                                <div id="emailPanel" class="p-2">
                                    <form>
                                        <div class="mb-4">
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="button" class="btn btn-success w-100 sendEmail" type="submit">Send Reset Link</button>
                                        </div>
                                    </form><!-- end form -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script>  City University <i class="mdi mdi-heart text-danger"></i>
                            </p>
                        </div>
                    </div>
                </div>
