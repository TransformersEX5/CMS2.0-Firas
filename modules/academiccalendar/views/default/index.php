...
$this->title = Yii::t('app', 'Academic Calendar List');
...
$canDelete = Yii::$app->user->can('Academic-Calendar-Upload');
$canEdit = Yii::$app->user->can('Academic-Calendar-Upload');
    ...
    var table = $('#cmstable1').DataTable({
        ...
        { 
	    	...
	    	"columns": [
                ...
                {"data":"UploadDocumentCategory", "width": '25.0%'},
