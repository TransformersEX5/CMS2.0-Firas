...
<div class="col-12"><?php $form = ActiveForm::begin(['id' => 'AcademicCalendarId', 'options' => ['enctype' => 'multipart/form-data']]); ?>
    <div class="card-body">
        <div class="col-md-12">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <?= Html::dropDownList('UploadDocumentCategoryId', null, [1 => 'Student Portal', 2 => 'Lecturer Portal'], ['class' => 'form-control text-dark border-dark', 'id' => 'UploadDocumentCategoryId', 'required' => 'required']) ?>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <?= $form->field($model, 'Year')->textInput(['placeholder' => 'Example: '.$curYear, 'class' => 'form-control text-dark border-dark', 'type' => 'number', 'required' => 'required'])->label(false); ?>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <?= $form->field($model, 'UploadDocument[]')->fileInput(['multiple' => false, 'accept' => 'application/pdf'])->label(false) ?>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <ol type="i">
                        ...
                        <li>File name should be like this: "ACADEMIC_CALENDAR_2024_FOUNDATION_PROGRAM"</li>
