 ...
 * @property int $UploadDocumentCategoryId
...
class Tbluploaddocument extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['UploadDocumentCategoryId', 'UploadDocumentTypeId', 'UploadDocumentTitle', 'UploadDocument', 'Year', 'UserId', 'Visibility'], 'required'],
            [['UploadDocumentCategoryId', 'UploadDocumentTypeId', 'Year', 'UserId', 'StatusId', 'Visibility'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'UploadDocumentCategoryId' => 'Upload Document Category ID',
