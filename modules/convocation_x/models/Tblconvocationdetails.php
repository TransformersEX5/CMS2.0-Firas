 ...
 * @property float|null $ExtraGuestCharge
...
class Tblconvocationdetails extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ConvoFee', 'MaxGuests', 'ExtraGuestCharge', 'RobeDeposit', 'RobeNonReturnFee'], 'number'],
            [['ConvoStatus'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ExtraGuestCharge' => 'Additional Guest Charge (RM)',
            'ConvoYear' => 'Year',
            'BriefDate' => 'Date',
