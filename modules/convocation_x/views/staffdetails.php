...
$convostaffdetail = Url::base() . '/admin/convostaffdetail';
$getstaffdetails = Url::base() . '/admin/getstaffdetails';
$urlRedirect = Url::base() . '/admin/staff';
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><?php if(isset($posId)){ ?>Register<?php }else{ ?>Update<?php } ?></button>
            </div>
