...
$details = Url::base() . '/admin/details';
...
var table = $('#datatable-registration').DataTable({
    ...
    "columns": [
        ...
        {"data":"ConvoStatus", class:"text-dark"},	
        {
            ...
            "render": function (data, type, row, meta) 
            {
                return '<button type="button" class="btn btn-primary waves-effect waves-light editConvo" data-bs-toggle="modal" data-bs-target="#DetailsModal" value='+ JSON.stringify(data) +'>Edit</button>'
            }
        },														
    ]
});
