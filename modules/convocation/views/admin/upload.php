...
use app\models\tblconvocationdetails;
...
$url = Url::base() . '/admin/yearlist?year=';
$uploaddetails = Url::base() . '/admin/uploaddetails';
$image = Url::base() . '/admin/image';
$deleteImage = Url::base() . '/admin/deleteimage';
