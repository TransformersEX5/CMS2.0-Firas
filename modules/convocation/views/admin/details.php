...
$urlConvocationdetails = Url::base() . '/admin/convocationdetails';
$urlRedirect = Url::base() . '/admin';
...
<div class="col-12"><?php $form = ActiveForm::begin(['id' => 'ConvoDetailsId']); ?>
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4 mb-2">
                <?= $form->field($model, 'ExtraGuestCharge')->textInput(['class' => 'form-control text-dark border-dark', 'type' => 'number', 'required' => 'required']) ?>
            </div>
