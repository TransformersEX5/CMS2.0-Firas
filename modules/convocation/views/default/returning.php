...
use app\modules\convocation\models\tblbranch;
...
$urlGetStud = Url::base() . $module . '/default/getstud?branch=';
$urlGetReturningStud = Url::base() . $module . '/default/getreturningstud';
$returningdetails = Url::base() . $module . '/default/returningdetails?branch=';
$returningdetails2 = Url::base() . $module . '/default/returningdetails?convoregId=';
...
function getStud(branch,search){
    ...
    var table = $('#datatable-registration').DataTable({
        ...
        {"data":"StudName", "width": '64.0%', class:"text-dark"},		
        {"data":"StudNRICPassportNo", "width": '16.9%', class:"text-dark"},	
        {"data":"StudentNo", "width": '15.9%', class:"text-dark"},	
        {
