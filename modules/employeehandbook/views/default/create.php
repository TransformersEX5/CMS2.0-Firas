...
<div class="col-12"><?php $form = ActiveForm::begin(['id' => 'EmployeeHandbookId', 'options' => ['enctype' => 'multipart/form-data']]); ?>
    <div class="card-body">
        <div class="col-md-12">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <ol type="i">
                        ...
                        <li>File name should be like this: "CITYU_2024_EMPLOYEE_HANDBOOK"</li>
