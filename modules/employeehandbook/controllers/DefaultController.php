...
namespace app\modules\employeehandbook\controllers;
...
use app\modules\employeehandbook\models\tbluploaddocument;

/**
 * Default controller for the `employeehandbook` module
 */
class DefaultController extends Controller
{
    ...
    {
        if (Yii::$app->user->can('Employee-Handbook-Index')) {
    ...
    {
        if (Yii::$app->user->can('Employee-Handbook-Upload')) {
    ...
    public function actionUpload()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->request->isAjax) {
            ...
            if ($model->save()) {
                ...
                $uploadPath = Yii::getAlias('@documentupload/employeehandbook/' . $model->Year);
    ...
    public function actionDocumentlist()
    {
        ...
        WHERE (UploadDocument REGEXP '$searchbox' OR YEAR REGEXP '$searchbox') AND UploadDocumentTypeId = 10 AND Visibility = 1
