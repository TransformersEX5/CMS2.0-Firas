 ...
 $(document).ready(function () {
    ...
    $("#cboBlockOnOff").change(function(){
        ...
        if(document.getElementById("cboBlockOnOff").value==1){
            $('#txtRemarks').val("Info, your access for class time table /LMS open for 7 days. Please make balance payment. "); 

        } else {
                       
            $('#txtRemarks').val("Sorry, your access for class time table /LMS  has been block, Please check your outstanding payment or you can refer to Bursary Unit for more info."); 
        };
     });
