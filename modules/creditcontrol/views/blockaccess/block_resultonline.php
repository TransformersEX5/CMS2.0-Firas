...
This remarks can be seen by everyonesssss
 ...
 $(document).ready(function () {
    ...
    $("#cboBlockOnOff").change(function(){
        ...
        if(document.getElementById("cboBlockOnOff").value==1){
            $('#txtRemarks').val("Info, your access for exam result open for 7 days. Please make balance payment. "); 

        } else {
                       
            $('#txtRemarks').val("Sorry, your access for exam result has been block, Please check your outstanding payment or you can refer to Bursary Unit for more info."); 
        };
     });
