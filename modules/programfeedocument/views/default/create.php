...
<div class="col-12"><?php $form = ActiveForm::begin(['id' => 'ProgramFeeDocumentId', 'options' => ['enctype' => 'multipart/form-data']]); ?>
    <div class="card-body">
        <div class="col-md-12">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    <?= $form->field($model, 'UploadDocument[]')->fileInput(['multiple' => false, 'accept' => '.pdf, .xls, .xlsx'])->label(false) ?>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <ol type="i">
                        <li>File must be in pdf or excel format.</li>
                        <li>File name should be like this: "LOCAL_2024_NORMAL_FEE"
                        <br> <?= $space; ?>"INTERNATIONAL_2024_NORMAL_FEE"
                        <br> <?= $space; ?>"INTERNATIONAL_2024_ALUMNI_FEE"</li>
