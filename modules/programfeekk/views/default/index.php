            ...
            <div class="card-header align-items-center text-white bg-primary">
                    <h4 class="card-title mb-0 flex-grow-1  ">
                        <div class="d-flex justify-content-between">
                            <div> <?= $this->title ?></div>
                            <div class="d-flex justify-content-center"> Progrem Fee - KK</div>
...
<?php
/**********************************************************************************/
$url = Url::toRoute(['/programfeekk/default/programfeecategorylist']);
$urlfee = Url::toRoute(['/programfeekk/default/programfeecategorydetaillist']);
$urlfeehistory = Url::toRoute(['/programfeekk/default/programfeecategorylisthistory']);
$create = Url::toRoute(['/programfeekk/default/create']);
$update = Url::toRoute(['/programfeekk/default/update']);
$view = Url::toRoute(['/programfeekk/default/view']);
$viewprogram = Url::toRoute(['/programfeekk/default/viewprogram']);
$viewstudent = Url::toRoute(['/programfeekk/default/viewstudent']);

$urlfee_save = Url::toRoute(['/programfeekk/programfeecategorydetail/create']);
$urlfee_remove = Url::toRoute(['/programfeekk/programfeecategorydetail/delete']);

$programvsfees = Url::toRoute(['/programfeekk/default/programvsfees']);

$view = Url::toRoute(['/programfeekk/default/view']);

$urlprogram = Url::toRoute(['/programfeekk/default/programlist']);

$urlprogramintake = Url::toRoute(['/programfeekk/default/programintakelist']);

$urlfeestructure = Url::toRoute(['/programfeekk/default/feestructure']);

$setfeegroupvsprogram = Url::toRoute(['/programfeekk/default/setfeegroupprogram']);

$removefeegroupvsprogram = Url::toRoute(['/programfeekk/default/removefeegroupprogram']);
