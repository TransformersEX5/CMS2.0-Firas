...
class Tblprogramfeecategory extends \yii\db\ActiveRecord
{
    ...
    public function getProgramIntake()
    {
        ...
        LEFT JOIN tblprogramfeecategorydetail ON tblprogramfeecategorydetail.ProgFeeCatId = tblprogramfeecategory.ProgFeeCatId
        LEFT JOIN tbluser ON tblprogramfee.UserId = tbluser.UserId
        ...
        WHERE tblprogrambatch.ProgramId = $txtprogramid
                and tblintake.IntakeYrMo >=202401 
                #and  tblprogrambatch.StatusId = 1
