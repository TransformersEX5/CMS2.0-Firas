            ...
            <div class="card-header align-items-center text-white bg-primary">
                    <h4 class="card-title mb-0 flex-grow-1  ">
                        <div class="d-flex justify-content-between">
                            <div> <?= $this->title ?></div>
                            <div class="d-flex justify-content-center"> Progrem Fee - PJ</div>
...
<?php
/**********************************************************************************/
$url = Url::toRoute(['/programfee/default/programfeecategorylist']);
$urlfee = Url::toRoute(['/programfee/default/programfeecategorydetaillist']);
$urlfeehistory = Url::toRoute(['/programfee/default/programfeecategorylisthistory']);
$create = Url::toRoute(['/programfee/default/create']);
$update = Url::toRoute(['/programfee/default/update']);
$view = Url::toRoute(['/programfee/default/view']);
$viewprogram = Url::toRoute(['/programfee/default/viewprogram']);
$viewstudent = Url::toRoute(['/programfee/default/viewstudent']);

$urlfee_save = Url::toRoute(['/programfeecategorydetail/create']);
$urlfee_remove = Url::toRoute(['/programfeecategorydetail/delete']);


$programvsfees = Url::toRoute(['/programfee/default/programvsfees']);

$view = Url::toRoute(['/programfee/default/view']);

$urlprogram = Url::toRoute(['/programfee/default/programlist']);

$urlprogramintake = Url::toRoute(['/programfee/default/programintakelist']);

$urlfeestructure = Url::toRoute(['/programfee/default/feestructure']);

$setfeegroupvsprogram = Url::toRoute(['/programfee/default/setfeegroupprogram']);

$removefeegroupvsprogram = Url::toRoute(['/programfee/default/removefeegroupprogram']);
