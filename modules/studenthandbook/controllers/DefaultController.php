...
namespace app\modules\studenthandbook\controllers;
...
use app\modules\studenthandbook\models\tbluploaddocument;

/**
 * Default controller for the `studenthandbook` module
 */
class DefaultController extends Controller
{
    ...
    {
        if (Yii::$app->user->can('Student-Handbook-Index')) {
    ...
    {
        if (Yii::$app->user->can('Student-Handbook-Upload')) {
    ...
    public function actionUpload()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->request->isAjax) {
            ...
            if ($model->save()) {
                ...
                $uploadPath = Yii::getAlias('@documentupload/studenthandbook/' . $model->Year);
    ...
    public function actionDocumentlist()
    {
        ...
        WHERE (UploadDocument REGEXP '$searchbox' OR YEAR REGEXP '$searchbox') AND UploadDocumentTypeId = 9 AND Visibility = 1
