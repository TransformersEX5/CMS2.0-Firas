...
/**
 * This is the model class for table "tblusertest".
 *
 * @property int $UserId
 ...
 */
class Tblusertest extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['UserNo', 'FullName', 'ICPassportNo', 'EmailAddress', 'NationalityId', 'HandSetNo', 'PositionId', 'BranchId', 'WorkingStatusId', 'DateJoin', 'RaceId', 'Gender', 'DepartmentId', 'UserName', 'ChangePassword', 'ExtensionNo', 'MarketingTeamId','AgentNatureOfBusiness', 'AgentBusinessAddress', 'AgentSocialMedia', 'AgentPIC', 'AgentYearsInBusiness', 'AgentRecruitmentBranch', 'AgentPreferredCountry', 'AgentFocusedCountry', 'AgentInterestedProgram', 'AgentBankName', 'AgentBankBranch', 'AgentBankCountry', 'AgentBankSwiftCode'], 'required'],
