...
class IndustryexperienceController extends Controller
{
    ...
    public function actionIndustryexperiencelist()
    {
        $stmt = "SELECT
        tblworkspecialization.WorkSpecName,
        CONCAT(tbluseremploymenthistory.UploadFileName, ';', tbluseremploymenthistory.UserId) as UploadFileName,
		...
		WHERE tbluser.UserId = " . Yii::$app->user->identity->UserId . " AND TypeId = 1 
