   ...
   <div class="row">
       ...
       <h2 class="card-title">Teaching Experience</h2>

       <br>

       <div class='col-12 .col-sm-12'>
           <div class="box-body">
               <table id="cmstable5" class="table table-bordered table-hover" width="100%" cellspacing="0">
                   <thead>
                       <tr>
   ...
   <?php
    ...
    $getTeachExp = Url::toRoute(['teachingexperience/teachingexperiencelist']);
    ...
    $(document).ready(function(){
        ...
        $('a[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            if ($.fn.DataTable.isDataTable('#cmstable5')) {
                $('#cmstable5').DataTable().columns.adjust().draw();
            }
        });

        var table = $('#cmstable5').DataTable({
