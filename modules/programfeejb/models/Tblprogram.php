...
class Tblprogram extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ProgramCode', 'ProgramName', 'ProgramCode2', 'ProgramCode3', 'ProgramName3', 'FacultyId', 'SchoolId', 'ProgramType', 'ProgramFromId', 'ProgramStatus', 'ActCreditHours', 'StudyDurationFT', 'StudyDurationPT', 'AcadCalTypeId', 'MQAStatus', 'TransactionUpdated', 'EMSProgramCode', 'ProgramDesc', 'ProgSubFieldId', 'LearningMethodId', 'NecDetailId', 'PracticalStatusId'], 'required'],
            [['FacultyId', 'SchoolId', 'ProgramType', 'ProgramFromId', 'BranchId', 'ProgramStatus', 'AcadCalTypeId', 'NoOfSem', 'UserId', 'ProgSubFieldId', 'LearningMethodId', 'NecDetailId', 'PracticalStatusId', 'ProgMajorId', 'HideId', 'ReportGroup', 'ProgramCategoryId', 'ViewResult', 'ApplicationFee', 'HOPId'], 'integer'],
